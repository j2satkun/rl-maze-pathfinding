# -*- coding: utf-8 -*-
"""reinforcement-mouse-learning_BASELINE.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1hrQ1nQfU_rJ0MWe_Cj3cENaZAJzfuOuC
...
class BioModel(nn.Module):
    ...
    def forward(self, x):
        ...
        direct = self.direct_pathway(x)
        indirect = self.indirect_pathway(x)
